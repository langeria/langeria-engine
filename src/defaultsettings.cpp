...
void set_default_settings()
{
	...
	settings->setDefault("font_path", porting::getDataPath("fonts" DIR_DELIM "LanaPixel.ttf"));
	settings->setDefault("font_path_italic", porting::getDataPath("fonts" DIR_DELIM "LanaPixel.ttf"));
	settings->setDefault("font_path_bold", porting::getDataPath("fonts" DIR_DELIM "LanaPixel.ttf"));
	settings->setDefault("font_path_bold_italic", porting::getDataPath("fonts" DIR_DELIM "LanaPixel.ttf"));
	...
	settings->setDefault("mono_font_path", porting::getDataPath("fonts" DIR_DELIM "LanaPixel.ttf"));
	settings->setDefault("mono_font_path_italic", porting::getDataPath("fonts" DIR_DELIM "LanaPixel.ttf"));
	settings->setDefault("mono_font_path_bold", porting::getDataPath("fonts" DIR_DELIM "LanaPixel.ttf"));
	settings->setDefault("mono_font_path_bold_italic", porting::getDataPath("fonts" DIR_DELIM "LanaPixel.ttf"));
	settings->setDefault("mono_font_size_divisible_by", "1");
	settings->setDefault("fallback_font_path", porting::getDataPath("fonts" DIR_DELIM "LanaPixel.ttf"));
